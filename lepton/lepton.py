...
from lib import lepton_type as lt
...
class Lepton(QThread):
    ...
    KELVIN = -273.15
    FRAME_W = 80 # if lepton 3 = 160
    FRAME_H = 60 # if lepton 3 = 120

    _debug_level = DebugLevel.DBG_NONE
    _data_valid : list[bool]
    _min : int
    _max : int
    _rgb_enabled : bool
    _resync_count : int
    _total_resync_count : int

    # VoSPI stuff
    _spi_device : str   # spi port device name 
    _spi_fd : int       # spi descriptor
    _spi_mode : str     # spi mode
    _spi_bits : str     # spi bits per words
    _spi_speed : int    # spi clock max speed 

    _packet_count : int     # VoSPI Packet for each segment
    _packet_size : int      # VoSPI Packet size in bytes
    _segment_count : int    # VoSPI segment for each frame
    _segment_size : int     # Size of single segment

    _spi_raw_frame_buffer : list[int]   # VoSPI buffer to keep 4 consecutive valid segments
    _spi_raw_frame_buffer_size : int    # Size of the buffer for 4 segments

    _data_frame_buffer_16 : list[int]   # RAW 16bit frame buffer
    _data_frame_buffer_rgb : list[int]  # RGB888 frame buffer

    _buff_idx : int
    _segment_freq : float   # VoSPI Segment output frequency
    _current_segment : int  # Index of the last valid acquired segment (-1 if Lost Sync)

    # Lepton Control over I2C
    _cci_connected : bool
    _cci_port : str
    _cci_con_port : lt.LEP_CAMERA_PORT_DESC_T



    def __init__(self, spi_device, i2c_port, debug_level = DebugLevel.DBG_FULL) -> None:
        pass
    ...
    def get_sensor_temperature_k(self) -> lec.LEP_RESULT:
        pass

    def enable_radiometry(self, enable : bool) -> lec.LEP_RESULT :
        pass

    def get_radiometry_status(self, status : bool) -> lec.LEP_RESULT :
        pass

    def get_agc_status(self, status : bool) -> lec.LEP_RESULT :
        pass

    def enable_agc(self, enable : bool) -> lec.LEP_RESULT :
        pass

    def get_gain_mode(self, mode : ls.LEP_SYS_GAIN_MODE_E) -> lec.LEP_RESULT :
        pass

    def set_gain_mode(self, new_mode : ls.LEP_SYS_GAIN_MODE_E) -> lec.LEP_RESULT :
        pass

    def enable_telemetry(self, enable : bool) -> lec.LEP_RESULT :
        pass

    def get_telemetry_status(self, status : bool) -> lec.LEP_RESULT:
        pass

    def get_video_format(self, format : lo.LEP_OEM_VIDEO_OUTPUT_FORMAT_E) -> lec.LEP_RESULT:
        pass

    def enable_rgb_output(self, status : bool) -> lec.LEP_RESULT:
        pass

    def set_rgb_lut(self) -> lec.LEP_RESULT:
        pass

    def perform_ffc(self) -> lec.LEP_RESULT:
        pass

    def perform_rad_ffc(self) -> lec.LEP_RESULT:
        pass

    def reset_camera(self) -> lec.LEP_RESULT:
        pass

    def reboot_camera(self) -> lec.LEP_RESULT:
        pass

    def save_params(self, status : bool) -> lec.LEP_RESULT:
        pass

    def load_params(self, status : bool) -> lec.LEP_RESULT:
        pass

    def is_rgb_enabled(self)->bool:
        pass

    def _thread_func(self):
        pass

    def _spi_open_port(self)->bool:
        pass

    def _spi_close_port(self):
        pass

    def _spi_read_segment(self) -> int:
        pass

    def _resync(self):
        pass

    def _raw_2_data16(self):
        pass

    def _raw_2_rgb(self):
        pass

    def _set_spi_data(self):
        pass

    def _cci_connect(self) -> bool:
        pass
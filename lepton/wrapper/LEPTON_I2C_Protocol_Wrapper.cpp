...
PYBIND11_MODULE(lepton_i2c_protocol, handle){
    ...
    py::enum_<LEP_I2C_COMMAND_STATUS_E>(handle,"LEP_I2C_COMMAND_STATUS_E")
        .value("LEP_I2C_COMMAND_NOT_BUSY",LEP_I2C_COMMAND_STATUS_E::LEP_I2C_COMMAND_NOT_BUSY)
        .value("LEP_I2C_COMMAND_IS_BUSY",LEP_I2C_COMMAND_STATUS_E::LEP_I2C_COMMAND_IS_BUSY)
        .value("LEP_I2C_END_COMMAND_STATUS",LEP_I2C_COMMAND_STATUS_E::LEP_I2C_END_COMMAND_STATUS)
        .export_values();

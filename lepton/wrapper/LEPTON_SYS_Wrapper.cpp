...
PYBIND11_MODULE(lepton_sys, handle){
    ...
    py::enum_<LEP_SYS_TELEMETRY_ENABLE_STATE_E>(handle,"LEP_SYS_TELEMETRY_ENABLE_STATE_E")
        .value("LEP_TELEMETRY_DISABLED",LEP_SYS_TELEMETRY_ENABLE_STATE_E::LEP_TELEMETRY_DISABLED)
        .value("LEP_TELEMETRY_ENABLED",LEP_SYS_TELEMETRY_ENABLE_STATE_E::LEP_TELEMETRY_ENABLED)
        .value("LEP_END_TELEMETRY_ENABLE_STATE",LEP_SYS_TELEMETRY_ENABLE_STATE_E::LEP_END_TELEMETRY_ENABLE_STATE)
        .export_values();

    py::enum_<LEP_SYS_TELEMETRY_LOCATION_E>(handle,"LEP_SYS_TELEMETRY_LOCATION_E")
        .value("LEP_TELEMETRY_LOCATION_HEADER",LEP_SYS_TELEMETRY_LOCATION_E::LEP_TELEMETRY_LOCATION_HEADER)
        .value("LEP_TELEMETRY_LOCATION_FOOTER",LEP_SYS_TELEMETRY_LOCATION_E::LEP_TELEMETRY_LOCATION_FOOTER)
        .value("LEP_END_TELEMETRY_LOCATION",LEP_SYS_TELEMETRY_LOCATION_E::LEP_END_TELEMETRY_LOCATION)
        .export_values();

    py::enum_<LEP_SYS_FRAME_AVERAGE_DIVISOR_E>(handle,"LEP_SYS_FRAME_AVERAGE_DIVISOR_E")
        .value("LEP_SYS_FA_DIV_1",LEP_SYS_FRAME_AVERAGE_DIVISOR_E::LEP_SYS_FA_DIV_1)
        .value("LEP_SYS_FA_DIV_2",LEP_SYS_FRAME_AVERAGE_DIVISOR_E::LEP_SYS_FA_DIV_2)
        .value("LEP_SYS_FA_DIV_4",LEP_SYS_FRAME_AVERAGE_DIVISOR_E::LEP_SYS_FA_DIV_4)
        .value("LEP_SYS_FA_DIV_8",LEP_SYS_FRAME_AVERAGE_DIVISOR_E::LEP_SYS_FA_DIV_8)
        .value("LEP_SYS_FA_DIV_16",LEP_SYS_FRAME_AVERAGE_DIVISOR_E::LEP_SYS_FA_DIV_16)
        .value("LEP_SYS_FA_DIV_32",LEP_SYS_FRAME_AVERAGE_DIVISOR_E::LEP_SYS_FA_DIV_32)
        .value("LEP_SYS_FA_DIV_64",LEP_SYS_FRAME_AVERAGE_DIVISOR_E::LEP_SYS_FA_DIV_64)
        .value("LEP_SYS_FA_DIV_128",LEP_SYS_FRAME_AVERAGE_DIVISOR_E::LEP_SYS_FA_DIV_128)
        .value("LEP_SYS_END_FA_DIV",LEP_SYS_FRAME_AVERAGE_DIVISOR_E::LEP_SYS_END_FA_DIV)
        .export_values();

    py::class_<LEP_SYS_SCENE_STATISTICS_T>(handle,"LEP_SYS_SCENE_STATISTICS_T")
        .def(py::init<>())
        .def_readwrite("meanIntensity", &LEP_SYS_SCENE_STATISTICS_T::meanIntensity)
        .def_readwrite("maxIntensity", &LEP_SYS_SCENE_STATISTICS_T::maxIntensity)
        .def_readwrite("minIntensity", &LEP_SYS_SCENE_STATISTICS_T::minIntensity)
        .def_readwrite("numPixels", &LEP_SYS_SCENE_STATISTICS_T::numPixels);

    py::class_<LEP_SYS_BAD_PIXEL_T>(handle,"LEP_SYS_BAD_PIXEL_T")
        .def(py::init<>())
        .def_readwrite("row", &LEP_SYS_BAD_PIXEL_T::row)
        .def_readwrite("col", &LEP_SYS_BAD_PIXEL_T::col)
        .def_readwrite("value", &LEP_SYS_BAD_PIXEL_T::value)
        .def_readwrite("value2", &LEP_SYS_BAD_PIXEL_T::value2);

    py::class_<LEP_SYS_VIDEO_ROI_T>(handle,"LEP_SYS_VIDEO_ROI_T")
        .def(py::init<>())
        .def_readwrite("row", &LEP_SYS_VIDEO_ROI_T::startCol)
        .def_readwrite("row", &LEP_SYS_VIDEO_ROI_T::startRow)
        .def_readwrite("row", &LEP_SYS_VIDEO_ROI_T::endCol)
        .def_readwrite("row", &LEP_SYS_VIDEO_ROI_T::endRow);

    py::enum_<LEP_SYS_ENABLE_E>(handle,"LEP_SYS_ENABLE_E")
        .value("LEP_SYS_DISABLE",LEP_SYS_ENABLE_E::LEP_SYS_DISABLE)
        .value("LEP_SYS_ENABLE",LEP_SYS_ENABLE_E::LEP_SYS_ENABLE)
        .value("LEP_END_SYS_ENABLE",LEP_SYS_ENABLE_E::LEP_END_SYS_ENABLE)
        .export_values();

    py::enum_<LEP_SYS_SHUTTER_POSITION_E>(handle,"LEP_SYS_SHUTTER_POSITION_E")
        .value("LEP_SYS_SHUTTER_POSITION_UNKNOWN",LEP_SYS_SHUTTER_POSITION_E::LEP_SYS_SHUTTER_POSITION_UNKNOWN)
        .value("LEP_SYS_SHUTTER_POSITION_IDLE",LEP_SYS_SHUTTER_POSITION_E::LEP_SYS_SHUTTER_POSITION_IDLE)
        .value("LEP_SYS_SHUTTER_POSITION_OPEN",LEP_SYS_SHUTTER_POSITION_E::LEP_SYS_SHUTTER_POSITION_OPEN)
        .value("LEP_SYS_SHUTTER_POSITION_CLOSED",LEP_SYS_SHUTTER_POSITION_E::LEP_SYS_SHUTTER_POSITION_CLOSED)
        .value("LEP_SYS_SHUTTER_POSITION_BRAKE_ON",LEP_SYS_SHUTTER_POSITION_E::LEP_SYS_SHUTTER_POSITION_BRAKE_ON)
        .value("LEP_SYS_SHUTTER_POSITION_END",LEP_SYS_SHUTTER_POSITION_E::LEP_SYS_SHUTTER_POSITION_END)
        .export_values();

    py::enum_<LEP_SYS_FFC_SHUTTER_MODE_E>(handle,"LEP_SYS_FFC_SHUTTER_MODE_E")
        .value("LEP_SYS_SHUTTER_POSITION_UNKNOWN",LEP_SYS_FFC_SHUTTER_MODE_E::LEP_SYS_FFC_SHUTTER_MODE_MANUAL)
        .value("LEP_SYS_FFC_SHUTTER_MODE_AUTO",LEP_SYS_FFC_SHUTTER_MODE_E::LEP_SYS_FFC_SHUTTER_MODE_AUTO)
        .value("LEP_SYS_FFC_SHUTTER_MODE_EXTERNAL",LEP_SYS_FFC_SHUTTER_MODE_E::LEP_SYS_FFC_SHUTTER_MODE_EXTERNAL)
        .value("LEP_SYS_FFC_SHUTTER_MODE_END",LEP_SYS_FFC_SHUTTER_MODE_E::LEP_SYS_FFC_SHUTTER_MODE_END)
        .export_values();

    py::enum_<LEP_SYS_SHUTTER_TEMP_LOCKOUT_STATE_E>(handle,"LEP_SYS_SHUTTER_TEMP_LOCKOUT_STATE_E")
        .value("LEP_SYS_SHUTTER_LOCKOUT_INACTIVE",LEP_SYS_SHUTTER_TEMP_LOCKOUT_STATE_E::LEP_SYS_SHUTTER_LOCKOUT_INACTIVE)
        .value("LEP_SYS_SHUTTER_LOCKOUT_HIGH",LEP_SYS_SHUTTER_TEMP_LOCKOUT_STATE_E::LEP_SYS_SHUTTER_LOCKOUT_HIGH)
        .value("LEP_SYS_SHUTTER_POSITION_UNKNOWN",LEP_SYS_SHUTTER_TEMP_LOCKOUT_STATE_E::LEP_SYS_SHUTTER_LOCKOUT_LOW)
        .export_values();

    py::class_<LEP_SYS_FFC_SHUTTER_MODE_OBJ_T>(handle,"LEP_SYS_FFC_SHUTTER_MODE_OBJ_T")
        .def(py::init<>())
        .def_readwrite("shutterMode",&LEP_SYS_FFC_SHUTTER_MODE_OBJ_T::shutterMode)
        .def_readwrite("tempLockoutState",&LEP_SYS_FFC_SHUTTER_MODE_OBJ_T::tempLockoutState)
        .def_readwrite("videoFreezeDuringFFC",&LEP_SYS_FFC_SHUTTER_MODE_OBJ_T::videoFreezeDuringFFC)
        .def_readwrite("ffcDesired",&LEP_SYS_FFC_SHUTTER_MODE_OBJ_T::ffcDesired)
        .def_readwrite("elapsedTimeSinceLastFfc",&LEP_SYS_FFC_SHUTTER_MODE_OBJ_T::elapsedTimeSinceLastFfc)
        .def_readwrite("desiredFfcPeriod",&LEP_SYS_FFC_SHUTTER_MODE_OBJ_T::desiredFfcPeriod)
        .def_readwrite("explicitCmdToOpen",&LEP_SYS_FFC_SHUTTER_MODE_OBJ_T::explicitCmdToOpen)
        .def_readwrite("desiredFfcTempDelta",&LEP_SYS_FFC_SHUTTER_MODE_OBJ_T::desiredFfcTempDelta)
        .def_readwrite("imminentDelay",&LEP_SYS_FFC_SHUTTER_MODE_OBJ_T::imminentDelay);
